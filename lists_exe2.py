...
if length == 100:
    print("Theer is 100 numbers in the list")
count_6 = pi_digits.count(6)    
if count_6 == 9:  
    print("The number 6 appears 9 times in the list")
sum = sum(pi_digits)
if sum == 471:
    print("The sum of all the numbers in the list is 471")    